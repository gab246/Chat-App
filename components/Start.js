     ...
     <TextInput
      ...
      <Text style={styles.colorChoiceTitle}>Choose Background Color:</Text>
        <View style={styles.colorButtonContainer}>
          <TouchableOpacity style={[styles.colorButtons, { backgroundColor: '#D4A37A'}]} 
          onPress={() => setColor('#D4A37A')}>
          </TouchableOpacity>

          <TouchableOpacity style={[styles.colorButtons, { backgroundColor: '#FEFAE0'}]}
          onPress={() => setColor('#FEFAE0')} >
          </TouchableOpacity>

          <TouchableOpacity style={[styles.colorButtons, { backgroundColor: '#8A95A5'}]}
          onPress={() => setColor('#8A95A5')} >
          </TouchableOpacity>

          <TouchableOpacity style={[styles.colorButtons, { backgroundColor: '#D8F3DC'}]}
